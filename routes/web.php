...
Route::group(['middleware' => ['web', 'checkblocked']], function () {
    Route::get('/', 'App\Http\Controllers\WelcomeController@welcome1')->name('welcome');
...
Route::get('/user-deletion-instruction', [LegalController::class, 'userDeletionInstruction'])->name('user-deletion-instruction');
Route::get('/privacy', [LegalController::class, 'privacyP'])->name('privacy-p');
...
Route::group(['middleware' => ['web', 'activity', 'checkblocked']], function () {
    Route::post('/web_login', [LoginController::class, 'webLogin'])->name('web_login');
    Route::get('/login/verify', [LoginController::class, 'verifyOTP'])->name('verify_otp');
    Route::post('/login/validate', [LoginController::class, 'validateOTP'])->name('validate_otp');
...
require_once __DIR__ . '/web/event.php';
