                ...
                <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
                    <div class="tabs -active-purple-2 js-tabs">
                        ...
                        <div class="tabs__content py-30 px-30 js-tabs-content">
                            ...
                            <div class="tabs__pane -tab-item-8  is-active">
                                <div class="row y-gap-20 justify-between pt-5 mb-2">
                                    <div class="col-auto sm:w-1/1">
                                        <h1 class="text-30 lh-12 fw-700">Pledges Categories</h1>
                                    </div>

                                    <div class="col-auto sm:w-1/1">
                                        <button data-toggle="modal" data-target="#add_pledge_category"
                                            class="button -pulse -sm -black text-blue-1 sm:w-1/1">
                                            <i class="icon icon-email mr-5"></i> Add Category
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive users-table">
                                    <table class="table table-striped table-sm data-table">
                                        <caption id="user_count">
                                            {{ $event->attendeesCategories->count() }} Event Pledges
                                        </caption>
                                        <thead class="thead">
                                            <tr>
                                                <th>No.</th>
                                        ...
                                        <tbody id="users_table">
                                            @foreach ($event->attendeesCategories as $attendeesCategory)
                                                <tr>
                                                    <td class="p-2 text-center">{{ $loop->iteration }}</td>
                                                    <td class="p-2">
                                                        <p>{{ $attendeesCategory->name }}</p>
                                                    </td>
                                                    ...
                                                    <td class="p-2">
                                                        <div class="shopCart-footer__item">
                                                            <button class="button -sm -purple-3 text-purple-1 mr-5"
                                                                data-toggle="modal"
                                                                data-target="#pledge_category_edit_{{ $attendeesCategory->id }}">Edit</button>
                                                            <button class="button -sm -outline-red-1 text-red-1"
                                                                data-toggle="modal"
                                                                data-target="#pledge_category_delete_{{ $attendeesCategory->id }}">Delete</button>
