                    ...
                    <div class="tabs -active-purple-2 js-tabs">
                        ...
                        <div class="tabs__content py-30 px-30 js-tabs-content">
                            ...
                            <div class="tabs__pane -tab-item-5 is-active">
                                ...
                                <hr>
                                <div class="pt-30">
                                    <form id="generateCardForm" action="{{ route('dash.event.card.send') }}" method="POST">
                                        @csrf
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-1">
                                             ...
                                             <div class="col-md-1">
                                                <label for="color" class="form-label">Qr Right</label>
                                                <input type="text" name="qr_left" id="qr_left" class="form-control"
                                                    value="{{ $event->qr_left }}" placeholder="e.g. 20"
                                                    style="border: 0.1px solid grey;" required>

                                            </div>

                                            <div class="col-md-1">
                                                <label for="color" class="form-label">Qr Top</label>
                                                <input type="text" name="qr_top" id="qr_top" class="form-control"
                                                    value="{{ $event->qr_top }}" placeholder="e.g. 20"
                                                    style="border: 0.1px solid grey;" required>

                                            </div>

                                             <div class="col-md-1">
                                                <label for="color" class="form-label">Qr Size</label>
                                                <input type="text" name="qr_width" id="qr_width" class="form-control"
                                                    value="{{ $event->qr_width }}" placeholder="e.g. 300"
                                                    style="border: 0.1px solid grey;" required>

                                            </div>
                                             <div class="col-md-1">
                                                <label for="color" class="form-label">Code Size</label>
                                                <input type="text" name="qr_code_font_size" id="qr_code_font_size" class="form-control"
                                                    value="{{ $event->qr_code_font_size }}" placeholder="e.g. 20"
                                                    style="border: 0.1px solid grey;" required>

                                            </div>

                                             <div class="col-md-2">
                                                <label for="color" class="form-label">CardType Size</label>
                                                <input type="text" name="card_type_font_size" id="card_type_font_size" class="form-control"
                                                    value="{{ $event->card_type_font_size }}" placeholder="e.g. 300"
                                                    style="border: 0.1px solid grey;" required>
