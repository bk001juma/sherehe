                    ...
                    <div class="tabs -active-purple-2 js-tabs">
                        ...
                        <div class="tabs__content py-30 px-30 js-tabs-content">
                            ...
                            <div class="tabs__pane -tab-item-5 is-active">
                                ...
                                {{-- <div class="col-auto">
                                        <div class="text-16 fw-500 text-dark-1 mb-4">Current Cards distributions</div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-md-6 col-12 mb-4">
                                        <a href="#" data-toggle="modal" data-target="#card_price"
                                            class="button -sm -black text-blue-1">Change Card Price</a>
                                    </div>
                                    <div class="col-xl-3 col-md-6 col-12 mb-4">
                                        <a href="#" data-toggle="modal" data-target="#upload_card_design"
                                            class="button -sm -black text-blue-1">Upload Your Design</a>
                                    </div>
                                    <div class="col-xl-3 col-md-6 col-12 mb-4">
                                        <a href="#" data-toggle="modal" data-target="#upload_welcome_note"
                                            class="button -sm -black text-blue-1">Upload Welcome Note</a>
                                    </div>
                                </div>
                                {{-- </div> --}}
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <h6 class="text-dark-5" style="color: white;">
                                                            TZS {{ number_format($event->card_types->single_amount) }}</h6>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Double:</td>
                                                    <td class="text-right">
                                                        <h6 class="text-dark-5" style="color: white;">
                                                            TZS {{ number_format($event->card_types->double_amount) }}</h6>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                        ...
                                        <div class="card d-flex justify-content-between align-items-center py-35 px-30 rounded-16"
                                            ...
                                            <table class="max-auto">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <h6 class="text-dark-5" style="color: white;">
                                                            {{ $event->welcome_note != null ? 'Yes' : 'Yes' }}</h6>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                ...
                                <div class="pt-30">
                                    <form action="{{ route('dash.event.card.send') }}" method="POST">
                                        ...
                                        <div class="text-16 fw-500 text-dark-1 mb-4">Card Designs</div>
                                        <div class="row g-3"> <!-- Use 'g-3' for gap between columns -->

                                            {{-- <div class="col-md-3">
                                                <div class="card h-100"> <!-- Use card component for better styling -->
                                                    <div class="card-body">
                                                        <iframe
                                                            src="{{ route('dash.event.card.show', ['id' => $event->id]) }}"
                                                            height="600px" style="width: 100%; border: none;"></iframe>
                                                        <!-- Set border to none for iframe -->
                                                    </div>
                                                    <div class="card-footer text-center"> <!-- Center the button -->
                                                        <input type="radio" name="selected_card" value="1"
                                                            id="card1" required> <!-- Radio button for Card 1 -->
                                                        <label for="card1">Select Card 1</label>

                                                        <a class="button"
                                                            href="{{ route('dash.event.card.download', ['id' => $event->id]) }}"
                                                            height="600px">Download Card</a>
                                                    </div>
                                                </div>
                                            </div> --}}

                                            @if ($event->designCard)
                                                <!-- Check if the event has any design cards -->
                                                @if ($event->designCard->single_card)
                                                    <!-- Check if the double card is not null -->
                                                    <div class="col-md-6">
                                                        <div class="card h-100">
                                                            ...
                                                            <div class="card-footer text-center">
                                                                {{-- <input type="radio" name="selected_card" value="2"
                                                                    id="card2" required> --}}
                                                                <label for="card2">Single Card</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endif
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="card h-100">
                                                            ...
                                                            <div class="card-footer text-center">
                                                                {{-- <input type="radio" name="selected_card" value="2"
                                                                    id="card2" required> --}}
                                                                <label for="card2">Double Card</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endif
