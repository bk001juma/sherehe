    ...
    <div class="dashboard__content bg-light-4" style="background-color: #f4f6f6 ">
        <div class="row y-gap-20 justify-between pt-30">
            ...
            <div class="col-auto sm:w-1/1 d-flex gap-3">
                ...
                <button data-toggle="modal" id="smsBalanceButton" style="background-color: #9aa89b;"
                    class="button -sm  text-white sm:w-1/1 mr-2">
                    SMS Balance: {{ number_format($event->sms_balance) }}
                </button>
                <button data-toggle="modal" id="buySMSButton" data-target="#buy_sms"
                    class="button -sm text-white  sm:w-1/1 mr-2" style="background-color: #9aa89b;">
                    <i class="fa fa-plus mr-5"></i> Buy SMS
                </button>
                ...
                <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
                    <div class="tabs -active-purple-2 js-tabs">
                        ...
                        <div class="tabs__content py-30 px-30 js-tabs-content">
                            ...
                            <div class="tabs__pane -tab-item-6 is-active">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-md-6 col-12 mb-4">
                                        <a href="{{ route('dash.notification.sms.create1', $event->id) }}"
                                    ...
                                    <div class="col-xl-3 col-md-6 col-12 mb-4">
                                        <div class="card d-flex justify-content-between align-items-center py-35 px-30 rounded-16"
                                            ...
                                            <table class="max-auto">
                                                ...
                                                <tr>
                                                    <td class="text-center">SMS Balance</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <h5 class="text-dark-5 text-center" style="color: white;">
                                                            {{ number_format($event->sms_balance) }}</h5>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                        ...
                                        <div class="card d-flex justify-content-between align-items-center py-35 px-30 rounded-16"
                                            ...
                                            <table class="max-auto">
                                                ...
                                                <tr>
                                                    <td>
                                                        <h5 class="text-dark-5 text-center" style="color: white;">
                                                            {{ number_format($event->total_used_messages) }}</h5>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                ...
                                <div class="row pt-30">
                                    <div class="col-12">
                                        {{--                                            <button class="button -sm -purple-1 text-white">Save Changes</button> --}}
                                    </div>
                                </div>
                            </div>
