                ...
                <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
                    <div class="tabs -active-purple-2 js-tabs">
                        ...
                        <div class="tabs__content py-30 px-30 js-tabs-content">
                            ...
                            <div class="tabs__pane -tab-item-10  is-active">
                                <div class="row y-gap-20 justify-between pt-5 mb-4">
                                    <div class="col-auto sm:w-1/1">
                                        <h1 class="text-30 lh-12 fw-700">Event Pledges (Link)</h1>
                                        <div class="mt-10">
                                    ...
                                    <div class="col-auto sm:w-1/1 d-flex gap-3">
                                        ...
                                        <a class="button -sm -dark-5 text-blue-1 mr-5"
                                            href="{{ route('dash.event.card.send.invitation.all.link', [$event->id]) }}"
                                            id="invitationButtonAllLink"
                                            onclick="handleInvitationClick(event, 'invitationButtonAllLink')">
                                            Invitation to All (Link)
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-2 mb-4">
                                        <label for="categorySelect1"
                                            style="font-weight: bold; color: rgba(161,194,53,255);">Select
                                            Category:</label>
                                        <select id="categorySelect1" class="form-control"
                                            onchange="showCategory1(this.value)"
                                    ...
                                    <div class="col-md-3 mb-4">
                                        <label for="searchPledge1" style="font-weight: bold;">Search Pledger:</label>
                                        <input type="text" id="searchPledge1" class="form-control"
                                            placeholder="Search by name or phone" onkeyup="filterPledges1()"
                                            style="border-radius: 5px; padding: 10px; border: 1px solid rgba(161,194,53,255);">
                                    </div>
                                </div>


                                <div class="content" id="contentAll1">
                                        ...
                                        <table class="table table-striped table-sm data-table">
                                            ...
                                            <tbody id="users_table1">
                                                @foreach ($event->pledges as $pledge)
                                                    <tr class="pledge-row1" data-category="{{ $pledge->category_id }}">
                                                                ...
                                                                @if (
                                                                    ...
                                                                    @if ($pledge->card_received)
                                                                        <a class="button -sm -black text-blue-1 mr-5"
                                                                            ...
                                                                            href="{{ route('dash.event.card.send.invitation.by.link', [$pledge->id]) }}"
                                                                            id="resendInvitationButtonLink2"
                                                                            onclick="handleInvitationClick(event, 'resendInvitationButtonLink2')">
                                                                            Resend Card (Link)
                                                                        </a>
                                                                    @else
                                                                        <a class="button -sm -dark-5 text-blue-1 mr-5"
                                                                            style="width: 200px;text-align: center;"
                                                                            href="{{ route('dash.event.card.send.invitation.by.link', [$pledge->id]) }}"
                                                                            id="resendInvitationButtonLink3"
                                                                            onclick="handleInvitationClick(event, 'resendInvitationButtonLink3')">
                                ...
                                @foreach ($event->attendeesCategories as $category)
                                    <div class="content category-content1" id="contentCategory1{{ $category->id }}"
                                        style="display: none;">
                                        <h3>{{ $category->name }}</h3>
                                        <div class="table-responsive users-table">
                                            <table class="table table-striped table-sm data-table">
                                                                    ...
                                                                    @if (
                                                                        ...
                                                                        @if ($pledge->card_received)
                                                                            <a class="button -sm -black text-blue-1 mr-5"
                                                                                style="width: 200px;text-align: center;"
                                                                                href="{{ route('dash.event.card.send.invitation.by.link', [$pledge->id]) }}"
                                                                                id="resendInvitationButton4"
                                                                                onclick="handleInvitationClick(event, 'resendInvitationButton4')">
                                                                                Resend Card (Link)
                                                                            </a>
                                                                        @else
                                                                            <a class="button -sm -dark-5 text-blue-1 mr-5"
                                                                                style="width: 200px;text-align: center;"
                                                                                href="{{ route('dash.event.card.send.invitation.by.link', [$pledge->id]) }}"
                                                                                id="inviteCardButton5"
                                                                                onclick="handleInvitationClick(event, 'inviteCardButton5')">
                                                                                Invitation Card (Link)
                                                                            </a>
                                                                        @endif
                                                                    @else
