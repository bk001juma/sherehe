                ...
                <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
                    <div class="tabs -active-purple-2 js-tabs">
                        ...
                        <div class="tabs__content py-30 px-30 js-tabs-content">
                            ...
                            <div class="tabs__pane -tab-item-12 is-active">
                                <div class="row y-gap-20 justify-between pt-5 mb-4">
                                    <div class="col-auto sm:w-1/1">
                                        <h1 class="text-30 lh-12 fw-700">Paid Tickets</h1>
                                        <div class="mt-10">
                                    ...
                                    <div class="col-auto sm:w-1/1 d-flex gap-3">
                                        <button data-toggle="modal" data-target="#add_pledge"
                                            ...
                                            <i class="icon icon-email mr-5"></i> Add Paid Ticket
                                        </button>
                                        <a class="button -sm -dark-5 text-blue-1 mr-5"
                                            href="{{ route('dash.event.ticket.send.invitation.all.paid', [$event->id]) }}"
                                            id="invitationButtonToAllPaidTicket"
                                            onclick="handleInvitationClick(event, 'invitationButtonToAllPaidTicket')">
                                            Invitation To All Paid Tickets
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-2 mb-4">
                                        <label for="categorySelectTicket"
                                            style="font-weight: bold; color: rgba(161,194,53,255);">Select
                                            Category:</label>
                                        <select id="categorySelectTicket" class="form-control"
                                            onchange="showCategoryTicket(this.value)"
                                            style="border-radius: 5px; padding: 10px; border: 1px solid rgba(161,194,53,255);">
                                            <option value="all">All Paid Tickets</option>
                                    ...
                                    <div class="col-md-3 mb-4">
                                        <label for="searchPledgeTicket" style="font-weight: bold;">Search Paid
                                            Tickets:</label>
                                        <input type="text" id="searchPledgeTicket" class="form-control"
                                            placeholder="Search by name or phone" onkeyup="filterPledgesPaidTickets()"
                                            style="border-radius: 5px; padding: 10px; border: 1px solid rgba(161,194,53,255);">
                                    </div>
                                </div>
                                ...
                                <div class="content" id="contentAllPaidTicket">
                                    <div class="table-responsive users-table">
                                        <table class="table table-striped table-sm data-table">
                                            <caption id="user_count">{{ $event->pledges->count() }} Paid Tickets
                                            </caption>
                                            ...
                                            <tbody id="users_table_ticket">
                                                @foreach ($event->pledges as $pledge)
                                                    <tr class="pledge-row_ticket"
                                                        data-category="{{ $pledge->category_id }}">
                                                        ...
                                                        {{-- <td class="p-2">
                                                            {{ $pledge->paid >= $event->card_types->single_amount && $pledge->paid < $event->card_types->double_amount ? 'Single' : ($pledge->paid >= $event->card_types->double_amount ? 'Double' : 'Incomplete') }}

                                                        </td> --}}
                                                        <td class="p-2">
                                                            {{ $pledge->paid >= $event->card_types->vvip_amount
                                                                ? 'VVIP'
                                                                : ($pledge->paid >= $event->card_types->vip_amount && $pledge->paid < $event->card_types->vvip_amount
                                                                    ? 'VIP'
                                                                    : ($pledge->paid >= $event->card_types->regular_amount && $pledge->paid < $event->card_types->vip_amount
                                                                        ? 'Regular'
                                                        ...
                                                        <td class="p-2">
                                                            <div class="shopCart-footer__item">
                                                                ...
                                                                {{-- @if (($pledge->paid >= $event->card_types->single_amount && $pledge->paid < $event->card_types->double_amount) || $pledge->paid >= $event->card_types->double_amount)
                                                                    @if ($pledge->card_received)
                                                                        <a class="button -sm -black text-blue-1 mr-5"
                                                                            style="width: 200px;text-align: center;"
                                                                            href="{{ route('dash.event.ticket.send.invitation', [$pledge->id]) }}"
                                                                            id="sendInvitationTicket"
                                                                            onclick="handleInvitationClick(event, 'sendInvitationTicket')">
                                                                            Resend Ticket
                                                                        </a>
                                                                    @else
                                                                        <a class="button -sm -dark-5 text-blue-1 mr-5"
                                                                            style="width: 200px;text-align: center;"
                                                                            href="{{ route('dash.event.ticket.send.invitation', [$pledge->id]) }}"
                                                                            id="sendInvitationTicket1"
                                                                            onclick="handleInvitationClick(event, 'sendInvitationTicket1')">
                                                                            Invitation Ticket
                                                                        </a>
                                                                    @endif
                                                                @else
                                ...
                                @foreach ($event->attendeesCategories as $category)
                                    <div class="content category-content_ticket"
                                        id="contentCategoryAllPaidTicket{{ $category->id }}" style="display: none;">
                                        <h3>{{ $category->name }}</h3>
                                        <div class="table-responsive users-table">
                                            <table class="table table-striped table-sm data-table">
                                                <caption id="user_count">{{ $category->eventAttendees()->count() }}
                                                    Paid Tickets in {{ $category->name }}</caption>
                                                <thead class="thead" style="background-color: #d3ccbc;">
                                                    <tr>
                                                        <th style="color: white;">No.</th>
                                                        <th style="color: white;">Name</th>
                                                                    ...
                                                                    @if (
                                                                        ...
                                                                        @if ($pledge->card_received)
                                                                            <a class="button -sm -black text-blue-1 mr-5"
                                                                                style="width: 200px;text-align: center;"
                                                                                href="{{ route('dash.event.ticket.send.invitation', [$pledge->id]) }}"
                                                                                id="sendInvitationTicket3"
                                                                                onclick="handleInvitationClick(event, 'sendInvitationTicket3')">
                                                                                Resend Ticket
                                                                            </a>
                                                                        @else
                                                                            <a class="button -sm -dark-5 text-blue-1 mr-5"
                                                                                style="width: 200px;text-align: center;"
                                                                                href="{{ route('dash.event.ticket.send.invitation', [$pledge->id]) }}"
                                                                                id="sendInvitationTicket4"
                                                                                onclick="handleInvitationClick(event, 'sendInvitationTicket4')">
                                                                                Invitation Ticket
                                                                            </a>
                                                                        @endif
                                                                    @else
