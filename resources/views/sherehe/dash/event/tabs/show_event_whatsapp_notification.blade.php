    ...
    <div class="dashboard__content bg-light-4" style="background-color: #f4f6f6 ">
        <div class="row y-gap-20 justify-between pt-30">
            ...
            <div class="col-auto sm:w-1/1 d-flex gap-3">
                ...
                <button data-toggle="modal" id="whatsAppBalanceButton" style="background-color: #9aa89b;"
                    class="button -sm  text-white sm:w-1/1 mr-2">
                    Balance: {{ number_format($event->whatsapp_balance) }}
                </button>
                {{-- <button data-toggle="modal" id="buyWhatsAppButton" data-target="#buy_whatsapp_sms"
                    class="button -sm text-white  sm:w-1/1" style="background-color: #9aa89b;">
                    <i class="fa fa-plus mr-5"></i> Buy WhatsApp SMS
                </button> --}}
                ...
                <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
                    <div class="tabs -active-purple-2 js-tabs">
                        ...
                        <div class="tabs__content py-30 px-30 js-tabs-content">
                            ...
                            <div class="tabs__pane -tab-item-7 is-active">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-md-6 col-12 mb-4">
                                        <a href="{{ route('dash.video.upload', $event->id) }}"
                                            class="button -sm -black text-blue-1">Upload Video</a>

                                    </div>
                                    <div class="col-xl-3 col-md-6 col-12 mb-4">
                                        <a href="{{ route('dash.notification.whatsAppsms.share.news', $event->id) }}"
                                            class="button -sm -black text-blue-1">Share News</a>
                                    </div>
                                    {{-- <div class="col-xl-3 col-md-6 col-12 mb-4">
                                        <a href="{{ route('dash.notification.whatsAppsms.create1', $event->id) }}"
                                            class="button -sm -black text-blue-1">Create Notifications</a>
                                    </div> --}}
                                </div>
                                    ...
                                    <div class="col-xl-3 col-md-6 col-12 mb-4">
                                        <div class="card d-flex justify-content-between align-items-center py-35 px-30 rounded-16"
                                            ...
                                            <table class="max-auto">
                                                ...
                                                <tr>
                                                    <td class="text-center">WhatsApp Balance</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <h5 class="text-dark-5 text-center" style="color: white;">
                                                            {{ number_format($event->whatsapp_balance) }}</h5>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
