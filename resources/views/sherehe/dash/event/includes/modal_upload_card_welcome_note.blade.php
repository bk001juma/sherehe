<div class="modal fade" id="upload_welcome_note" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
                ...
                <div class="courses-single-info__content scroll-bar-1 pt-30 pb-20 px-20">
                    <div class="shopCheckout-form">
                        <form action="{{ route('dash.event.upload_welcome_note', $event->id) }}"
                            enctype="multipart/form-data" method="post" id="add_welcome_note_form"
                            class="contact-form row x-gap-30 y-gap-30">
                            @csrf
                            <input type="hidden" name="event_id" value="{{ $event->id }}">

                            <div class="col-12">
                                <h5 class="text-20">Upload Your Welcome Note</h5>
                            </div>
            ...
            <div class="modal-footer">
                <div class="row y-gap-20 justify-between pt-30">
                    ...
                    <div class="col-auto sm:w-1/1">
                        <button type="submit" form="add_welcome_note_form"
