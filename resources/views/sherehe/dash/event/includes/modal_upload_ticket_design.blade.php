<div class="modal fade" id="upload_ticket_design" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
                ...
                <div class="courses-single-info__content scroll-bar-1 pt-30 pb-20 px-20">
                    <div class="shopCheckout-form">
                        <form action="{{ route('dash.event.card_type.upload_design', $event->id) }}"
                            enctype="multipart/form-data" method="post" id="add_ticket_design_form"
                            class="contact-form row x-gap-30 y-gap-30">
                            @csrf
                            <input type="hidden" name="event_id" value="{{ $event->id }}">

                            <div class="col-12">
                                <h5 class="text-20">Upload Your Ticket Design</h5>
                            </div>

                            <div id="one">
                                <div class="col-md-12">
                                    <label class="text-16 lh-1 fw-500 text-dark-1 mb-10">Double Ticket</label>
                                    <br>
                                ...
                                <div class="col-md-12">
                                    <label class="text-16 lh-1 fw-500 text-dark-1 mb-10">Single Ticket</label> <br>
            ...
            <div class="modal-footer">
                <div class="row y-gap-20 justify-between pt-30">
                    ...
                    <div class="col-auto sm:w-1/1">
                        <button type="submit" form="add_ticket_design_form"
