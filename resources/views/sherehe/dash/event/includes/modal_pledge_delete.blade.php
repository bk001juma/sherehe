@foreach($event->pledges as $pledge_delete)
    <div class="modal fade" id="pledge_delete_{{$pledge_delete->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content row justify-center text-center">
              ...
              <div class="courses-single-info__content scroll-bar-1 pt-30 pb-20 px-20">
                ...
                <div class="col-auto">
                  <div data-anim="slide-up delay-1" class="is-in-view text-red-1 mt-30">
                      ...
                      <h1 class="page-header__title text-dark-5">{{$pledge_delete->full_name}}?</h1>
                  </div>
          ...
          <div class="modal-footer">
            <div class="row y-gap-20 justify-between pt-30">
                ...
                <div class="col-auto sm:w-1/1">
                  <a href="{{route('dash.event.pledge.destroy',[$pledge_delete->id])}}" class="button -sm -red-1 text-white sm:w-1/1">Yes Delete</a>
                </div>
              </div>
          </div>
        </div>
