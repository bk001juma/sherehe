@foreach($events as $delete_event)
    <div class="modal fade" id="delete_class_{{$delete_event->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content row justify-center text-center">
              ...
              <div class="courses-single-info__content scroll-bar-1 pt-30 pb-20 px-20">
                ...
                <div class="col-auto">
                  <div data-anim="slide-up delay-1" class="is-in-view text-red-1 mt-30">
                      ...
                      <h1 class="page-header__title">{{$delete_event->event_name}}?</h1>
                  </div>
          ...
          <div class="modal-footer">
            <div class="row y-gap-20 justify-between pt-30">
                ...
                <div class="col-auto sm:w-1/1">
                  <a href="{{route('dash.event.delete',$delete_event->id)}}" class="button -sm -red-1 text-white sm:w-1/1">Yes Delete</a>
                </div>
              </div>
          </div>
        </div>
