<div class="modal fade" id="whatssap_notify_pledges" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="bg-white shadow-2 rounded-8 border-light py-10 px-10">
                ...
                <div class="courses-single-info__content scroll-bar-1 pt-30 pb-20 px-20">
                    <div class="shopCheckout-form">
                        <form action="{{ route('dash.notification.whatsAppsms.create', $event->id) }}" method="post"
                            id="whatssap_notify_sms" class="contact-form row x-gap-30 y-gap-30">
                            @csrf
                            <input hidden="hidden" name="event_id" value="{{ $event->id }}">
                            <div class="col-12">
                                <h5 class="text-20">Whatssap Notify Pledges</h5>
                            </div>
            ...
            <div class="modal-footer">
                <div class="row y-gap-20 justify-between pt-30">
                    ...
                    <div class="col-auto sm:w-1/1">
                        <button type="submit" form="whatssap_notify_sms"
