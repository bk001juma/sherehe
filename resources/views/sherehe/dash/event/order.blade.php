                    ...
                    <div class="row justify-center text-center">
                        <div class="col-auto">
                            ...
                            <div data-anim="slide-up delay-2">
                                ...
                                @else
                                    <p class="page-header__text">Event paid.</p>
                                @endif
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row no-gutters y-gap-32">
                                <div class="col-md-3 col-sm-6">
                                    <div class="shopCompleted-info__item">
                                        ...
                                        <div class="title text-purple-1 mt-5">{{$event->package_payment->id}}</div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="shopCompleted-info__item">
                                        ...
                                        <div class="title text-purple-1 mt-5">{{date('d M Y',strtotime($event->package_payment->created_at))}}</div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="shopCompleted-info__item">
                                        ...
                                        <div class="title text-purple-1 mt-5">{{number_format($event->package_payment->amount)}} TZS</div>
                                    </div>
                                </div>
                            ...
                            <div class="row y-gap-20 justify-between pt-30 pb-10">
                                ...
                                <div class="col-auto sm:w-1/1">
                                    @if(Auth::user()->hasRole('admin'))
                                        <a href="{{route('dash.event.activate',$event->id)}}" class="button -sm -red-1 text-black sm:w-1/1">
                                            Activate
                                        </a>
                                    @endif
