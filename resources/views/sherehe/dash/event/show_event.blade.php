                        ...
                        <div class="tabs__content py-30 px-30 js-tabs-content">
                            ...
                            <div class="tabs__pane -tab-item-1 is-active">
                                <div class="row y-gap-30 mb-10 d-flex" style="gap: 15px; flex-wrap: nowrap;">
                                    <div class="col-xl-4 col-md-4 rounded-16 d-flex justify-content-center align-items-center"
                                        style="background-color: #d3ccbc; padding: 5px; flex: 1 1 0%;">
                                        <div class="col-md-auto" style="width: 100%; height: 100%;">
                                            <div class="shrink-0" style="width: 100%; height: 100%;">
                                        ...
                                        <div class="">
                                            ...
                                            <table class="max-auto">
                                                <tr>
                                                    <td>Date:</td>
                                                    <td>
                                                        <h5 class="text-dark-5">
                                                            {{ date('D d M Y', strtotime($event->event_date)) }}</h5>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Phone Number:</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <h5>
                                                            {{ number_format($event->sms_balance) }}
                                                        </h5>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>WhatsApp Balance:</td>
                                                    <td class="text-right">
                                                        <h5>
                                                            {{ number_format($event->whatsapp_balance) }}
                                                        </h5>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <h5>
                                                            {{ number_format($event->pledges->count()) }}</h5>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Single Card:</td>
                                                    <td class="text-right">
                                                        <h5>
                                                            {{ number_format($event->contSingleInvitationWithCard()) }}
                                                        </h5>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <h5>
                                                            {{ number_format($event->contDoubleInvitationWithCard()) }}
                                                        </h5>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <h5>
                                                            {{ number_format($event->card_balance) }}
                                                        </h5>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <div class="col-md-4  d-flex rounded-16 justify-content-center align-items-center"
                                        style="background-color: #d3ccbc; padding: 5px;flex: 1 1 0%;">
                                        {{-- <h2>{{ $event->event_name }}</h2>
                                        <h6>{{ $event->description }}</h6> --}}
                                        <div>
                                            ...
                                            <table>
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <h5 class="text-dark-5">
                                                            {{ number_format($event->items->sum('amount')) }} TZS</h5>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Pledges:</td>
                                                    <td class="text-right">
                                                        <h5 class="text-dark-5">
                                                            {{ number_format($event->pledges->sum('amount')) }} TZS</h5>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Collected:</td>
                                                    <td class="text-right">
                                                        <h5 class="text-dark-5">
                                                            {{ number_format($event->pledges->sum('paid')) }} TZS</h5>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Not Collected:</td>
                                                    <td class="text-right">
                                                        <h5 class="text-dark-5">
                                                            {{ number_format($event->pledges->sum('amount') - $event->pledges->sum('paid')) }}
                                                            TZS</h5>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <h5 class="text-dark-5">
                                                            {{ number_format($event->items->sum('paid')) }}
                                                            TZS</h5>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <h5 class=""
                                                            style="color: {{ $event->pledges->sum('paid') - $event->items->sum('paid') < 0 ? 'red' : 'green' }}">
                                                            {{ number_format($event->pledges->sum('paid') - $event->items->sum('paid')) }}
                                                            TZS</h5>
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <div class="w-25 items-center mt-5">
                                                <div class="progress-bar mt-10">
                                                    <div class="progress-bar__bg bg-light-3"></div>
                                                    <div class="progress-bar__bar bg-purple-1"
                                                        style="width:{{ $event->pledges->sum('amount') > 0 ? ($event->pledges->sum('paid') / $event->pledges->sum('amount')) * 100 : 0 }}%">
                                                    </div>
                                                </div>
                                                <div class="d-flex y-gap-10 justify-between items-center mt-10">
                                                    <div class="text-dark-1">
                                                        {{ $event->pledges->sum('amount') > 0 ? round(($event->pledges->sum('paid') / $event->pledges->sum('amount')) * 100, 1) : 0 }}
                                                        % Collected</div>
