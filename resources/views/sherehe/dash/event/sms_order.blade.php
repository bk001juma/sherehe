                    ...
                    <div class="row justify-center text-center">
                        <div class="col-auto">
                            ...
                            <div data-anim="slide-up delay-2">
                                ...
                                @else
                                    <p class="page-header__text">SMS paid.</p>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-8 col-lg-9 col-md-11">
                        @if ($order->status == 'pending')
                            <div class="shopCompleted-header pt-5">
                                ...
                                <h2 class="title">
                                    Your order is almost complete.<br>
                                    <h4>Payment Pending</h4>
                                </h2>
                                {{--                                <img style="width: 60%" src="/lipa.jpg"> --}}
                                <div class="subtitle">
                                    <p>USSD sent to {{ $order->phone }}. <a style="color: darkred">Tap Here to Retry</a></p>
                            ...
                            <div class="row no-gutters y-gap-32">
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="shopCompleted-info__item">
                                        ...
                                        <div class="title text-purple-1 mt-5">{{ number_format($order->sms_count) }} SMS
                                        </div>
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="shopCompleted-info__item">
                                        ...
                                        <div class="title text-purple-1 mt-5">USSD Push</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row y-gap-20 justify-between pt-30 pb-10">
                            <div class="col-auto sm:w-1/1">
                                <h5>Current Balance SMS</h5>
                            </div>

                            <div class="col-auto sm:w-1/1">
                                @if (Auth::user()->hasRole('admin'))
                                    <a href="{{ route('sms.purchase.activate', $order->id) }}"
                                        class="button -sm -red-1 text-black sm:w-1/1">
                                        Activate
                                    </a>
                                @endif
                            ...
                            <div class="col-auto sm:w-1/1">
                                ...
                                <a href="{{ route('dash.event', [$event->id]) }}"
                                    class="button -sm -purple-1 text-white sm:w-1/1">
                                    Got to Event
                                </a>
                                {{--                                    @endif --}}
    ...
    <script>
        @if ($order->status != 'paid')
            ...
            function checkPayment() {
                var url = '{{ route('is_order_paid', $order->id) }}';
                ...
                setInterval(async function() {
                    try {
                        ...
                        console.log('Payment status:', text);
            ...
            async function paymentSuccessful() {
                await sleep(2000);
                window.location.href = '{{ route('dash.event', [$event->id]) }}';
            }
        ...
        {{-- function retryPay() { --}}
        {{--    alertMe('Payment Request Sent.<br> Please check your Phone.') --}}
        {{--    httpGet("{{route('retry_payment',$order->id)}}") --}}
        {{-- } --}}
